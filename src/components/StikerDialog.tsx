            ...
            <div className="flex h-full w-full">
              ...
              <div className="w-[55%] h-full flex flex-col" style={{ backgroundColor: '#ffffff' }}>
                ...
                <div className="flex justify-center items-center gap-2 pb-2 px-2" style={{ backgroundColor: '#ffffff' }}>
                  <img src="/logo-ugm.png" alt="UGM" style={{ height: '24px', objectFit: 'contain' }} />
                  <img src="/logo-kkn.png" alt="KKN" style={{ height: '24px', objectFit: 'contain' }} />
                  <img src="/Logo sorak no background.png" alt="Sorak" style={{ height: '24px', objectFit: 'contain' }} />
                </div>
              </div>
            </div>
          </div>
